<%@ Page Title="" Language="C#" MasterPageFile="~/MySite.Master" AutoEventWireup="true" CodeBehind="ShoppingCart.aspx.cs" Inherits="ASP_Shopping_2.ShoppingCart" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%--Bang danh sach san pham da duoc them vao gio hang--%>
    <%
        Response.Write("<input type='hidden' name='action' value='update' />\n");
        decimal total = 0;

        List<ASP_Shopping_2.CartItem> li = (List<ASP_Shopping_2.CartItem>)Session["Cart"];

        if (li != null)
        {
            Response.Write("<table>");
            Response.Write("<tr><th>Ma SP</th><th>Ten san pham</th><th>Hinh anh</th><th>Gia tien</th><th>So luong</th><th>Thanh tien</th><th>Xoa</th></tr>\n");
